...
use Symfony\Component\Validator\Mapping\ClassMetadata;
    ...
    {
    use \Customize\Entity\Product\CustomerTrait, \Customize\Entity\Customer\CustomerTrait;
         ...
         * @var string
         *
         * @ORM\Column(name="customer_id", type="string", length=255, nullable=true, unique=true)
         */
        private $customer_id;
         ...
         * @var \Doctrine\Common\Collections\Collection
         *
         * @ORM\OneToMany(targetEntity="Eccube\Entity\Order", mappedBy="Customer", cascade={"persist","remove"})
         */
        private $Orders;
        ...
        /**
          * @var \Customize\Entity\Master\CourseMaster
         *
         * @ORM\ManyToOne(targetEntity="\Customize\Entity\Master\CourseMaster")
         * @ORM\JoinColumns({
         *   @ORM\JoinColumn(name="course_master_id", referencedColumnName="id")
         * })
         *
         */
         ...
         * @var \Doctrine\Common\Collections\Collection
         *
         * @ORM\OneToMany(targetEntity="Eccube\Entity\GiftAddress", mappedBy="Customer", cascade={"remove"})
         * @ORM\OrderBy({
         *     "id"="ASC"
         * })
         */
        private $GiftAddresses;
         ...
         * Set CourseMaster.
         *
         * @param Customize\Entity\Master\CourseMaster|null $CourseMaster
         *
         * @return CourseMaster
         */
        public function setCourseMaster(\Customize\Entity\Master\CourseMaster $CourseMaster = null): self
        {
         ...
         * Get CourseMaster.
         *
         * @return Customize\Entity\Master\CourseMaster|null
         */
         ...
         * Add giftAddress.
         *
         * @param \Eccube\Entity\GiftAddress $giftAddress
         *
         * @return Customer
         */
        public function addGiftAddress(GiftAddress $giftAddress)
        {
            $this->GiftAddresses[] = $giftAddress;
         ...
         * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
         */
        public function removeGiftAddress(GiftAddress $giftAddress)
        {
            return $this->GiftAddresses->removeElement($giftAddress);
        }
         ...
         * @return \Doctrine\Common\Collections\Collection
         */
        public function getGiftAddresses()
        {
            return $this->GiftAddresses;
        }
           /**
         * Set unit_cost_rate
         *
