...
use Eccube\Service\PurchaseFlow\ItemCollection;
    ...
    {
        use NameTrait, \Customize\Entity\Order\OrderTrait;
        use PointTrait;
         ...
         *
         * @ORM\ManyToOne(targetEntity="Eccube\Entity\Customer", inversedBy="Orders", fetch="EAGER")
         * @ORM\JoinColumns({
         ...
         * @var string|null
         * 
         * @ORM\Column(name="order_comment", type="string", length=255, nullable=true)
         */
         ...
         * @var string|null
         * 
         * @ORM\Column(name="shipping_comment", type="string", length=255, nullable=true)
         */
         ...
         * @var string|null
         * 
         * @ORM\Column(name="message_for_this_time", type="string", length=255, nullable=true)
         */
        private $messageForThisTime;
...
//            $this->Shippings = $Shippings;
        ...
        public function getMessageForThisTime(): ?string
        {
            return $this->messageForThisTime;
        }

        public function setMessageForThisTime(string $messageForThisTime): self
        {
            $this->messageForThisTime = $messageForThisTime;
