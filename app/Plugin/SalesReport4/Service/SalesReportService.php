...
class SalesReportService
{
    ...
    private function convert($data)
    {
        ...
        switch ($this->reportType) {
            ...
            case 'age':
                ...
                break;
            case 'customer':
                $result = $this->convertByCustomer($data);
        }
     ...
     * @return array
     */
    private function convertByCustomer($data)
    {
        $label = [];
        $graphData = [];
        $backgroundColor = [];
            ...
            foreach ($Customer['Orders'] as $Order) {
                foreach ($Order['OrderItems'] as $OrderDetail) {
                    $Customer_id = $Customer->getId();
                        ...
                        $Customers[$Customer_id]['quantity'] += $OrderDetail->getQuantity();
                        $Customers[$Customer_id]['total'] += $OrderDetail->getTotalPrice();
                        ++$Customers[$Customer_id]['time'];
                }
            }
        }
        //sort by total money
