...
if (!class_exists('\Customize\Entity\Product\ProductSearchTemplate')) {
    /**
     * Sender
     *
     * @ORM\Table(name="dtb_product_search_template")
     * @ORM\InheritanceType("SINGLE_TABLE")
     * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
     * @ORM\HasLifecycleCallbacks()
     * @ORM\Entity(repositoryClass="Eccube\Repository\ProductSearchTemplateRepository")
     */
    class ProductSearchTemplate extends \Eccube\Entity\AbstractEntity
    {
        /**
         * @var int
         *
