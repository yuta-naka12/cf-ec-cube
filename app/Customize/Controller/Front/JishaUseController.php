...
class JishaUseController extends AbstractController
{
    /**
     ...
     * 自社会員登録画面.
     *
     * @Route("/entry/jisha-use", name="entry_jisha_use", methods={"GET", "POST"})
     * @Route("/entry/jisha-use", name="entry_jisha_use_confirm", methods={"GET", "POST"})
     * @Template("Entry/Jisha/jisha_use.twig")
     */
