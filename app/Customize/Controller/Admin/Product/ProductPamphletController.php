...
class ProductPamphletController extends AbstractController
{
    /**
...
//    /**
//     * @Route("/%eccube_admin_route%/product/pamphlet/", name="admin_product_pamphlet", methods={"GET", "POST"})
//     * @Route("/%eccube_admin_route%/product/pamphlet/{pamphlet_id}/{id}/edit", requirements={"pamphlet_id" = "\d+", "id" = "\d+"}, name="admin_product_pamphlet_edit", methods={"GET", "POST"})
//     * @Template("@admin/Product/class_category.twig")
//     */
//    public function index(Request $request, $pamphlet_id, $id = null)
//    {
//        $ClassName = $this->classNameRepository->find($pamphlet_id);
//        if (!$ClassName) {
...
//
//                return $this->redirectToRoute('admin_product_class_category', ['pamphlet_id' => $ClassName->getId()]);
//            }
//
...
//    /**
//     * @Route("/%eccube_admin_route%/product/class_category/{pamphlet_id}/{id}/delete", requirements={"pamphlet_id" = "\d+", "id" = "\d+"}, name="admin_product_class_category_delete", methods={"DELETE"})
//     */
//    public function delete(Request $request, $pamphlet_id, $id)
//    {
//        $this->isTokenValid();
//
//        $ClassName = $this->classNameRepository->find($pamphlet_id);
...
//
//    /**
//     * @Route("/%eccube_admin_route%/product/class_category/{pamphlet_id}/{id}/visibility", requirements={"pamphlet_id" = "\d+", "id" = "\d+"}, name="admin_product_class_category_visibility", methods={"PUT"})
//     */
//    public function visibility(Request $request, $pamphlet_id, $id)
//    {
//        $this->isTokenValid();
//
//        $ClassName = $this->classNameRepository->find($pamphlet_id);
