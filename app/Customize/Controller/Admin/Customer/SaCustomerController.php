...
class SaCustomerController extends AbstractController
{
    /**
    ...
    /**
     * @Route("/%eccube_admin_route%/customer/sa", name="admin_sa_customer", methods={"GET", "POST"})
     * @Route("/%eccube_admin_route%/customer/sa/page/{page_no}", requirements={"page_no" = "\d+"}, name="admin_sa_customer_page", methods={"GET", "POST"})
     * @Template("@admin/Customer/Sa/index.twig")
     */
    public function index(Request $request, $page_no = null, PaginatorInterface $paginator)
    {
        $session = $this->session;
        $builder = $this->formFactory->createBuilder(SearchSaCustomerType::class);
