...
if (!class_exists('\Eccube\Entity\Shipping')) {
    ...
    class Shipping extends \Eccube\Entity\AbstractEntity
    {
         ...
         * @var string
         *
         * @ORM\Column(name="address_book_use", type="string", length=255, nullable=true)
         */
        private $address_book_use;

        /**
         * @var string
         *
         * @ORM\Column(name="delivery_pattern", type="string", length=255, nullable=true)
         */
        private $delivery_pattern;
         ...
         * Set addressBookUse.
         *
         * @param string|null $addressBookUse
         *
         * @return Shipping
         */
        public function setAddressBookUse($addressBookUse = null)
        {
            $this->address_book_use = $addressBookUse;
         ...
         * @return string|null
         */
        public function getAddressBookUse()
        {
            return $this->address_book_use;
        }

        /**
         * Set deliveryPattern.
         *
         * @param string|null $deliveryPattern
         *
         * @return Shipping
         */
        public function setDeliveryPattern($deliveryPattern = null)
        {
            $this->delivery_pattern = $deliveryPattern;
         ...
         * @return string|null
         */
        public function getDeliveryPattern()
        {
            return $this->delivery_pattern;
        }
