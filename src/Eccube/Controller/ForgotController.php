...
class ForgotController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $Customer = $this->customerRepository
                ->getRegularCustomerByEmailAndPhoneNumber($form->get('login_email')->getData(), $form->get('login_phone_number')->getData());
     ...
     * 再設定URL送信完了画面.
     *
     * @Route("/forgot/password_reset_complete", name="forgot_reset_complete", methods={"GET"})
     * @Template("Forgot/password_reset_complete.twig")
     */
