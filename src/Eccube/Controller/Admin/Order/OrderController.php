...
use Customize\Repository\Admin\Order\OrderSearchTemplateRepository;
...
class OrderController extends AbstractController
{
    ...
    /**
     * @var OrderSearchTemplateRepository
     */
    protected $orderSearchTemplateRepository;
     ...
     * @param OrderSearchTemplateRepository $orderSearchTemplateRepository
    ...
    public function __construct(
        ...
        OrderSearchTemplateRepository $orderSearchTemplateRepository,
        ...
        $this->orderSearchTemplateRepository = $orderSearchTemplateRepository;
    ...
    public function index(Request $request, $page_no = null, PaginatorInterface $paginator)
    {
        ...
        // Get Order search templates
        $orderSearchTemplates = $this->orderSearchTemplateRepository->getAll($user);
        ...
        if ('POST' === $request->getMethod()) {
            ...
            if (!empty($requestData['search-template'])) {
                $searchTemplates = $this->orderSearchTemplateRepository->find($requestData['search-template']);
                ...
                $requestData['admin_search_order'] = $templateSearchData;
