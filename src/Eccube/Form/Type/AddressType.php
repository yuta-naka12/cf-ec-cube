...
class AddressType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $options['addr01_options']['required'] = true;
        $options['addr02_options']['required'] = true;
        $options['addr03_options']['required'] = false;
...
//            ->add('where_hear_about_this_site', TextType::class, ['required' => false]);
...
//        $builder->setAttribute('addr03_name', $options['addr03_name']);
        $builder->setAttribute('where_here_about_this_site',$options['required']);
    }
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        // $view->vars['where_here_about_this_site'] = $builder->getAttribute('where_here_about_this_site');
    }
