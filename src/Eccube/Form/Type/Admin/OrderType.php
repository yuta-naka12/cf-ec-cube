...
class OrderType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('messageForThisTime', TextareaType::class, [
                'required' => false,
                'constraints' => [
                    new Assert\Length([
                        'max' => $this->eccubeConfig['eccube_ltext_len'],
            ...
            ->add('order_date_confirm', DateType::class, [
                'required' => false,
                'format' => 'yyyy/MM/dd',
                'placeholder' => ''
            ])
            ...
            ->add('scheduled_delivery_date', DateType::class, [
                'required' => false,
                'format' => 'yyyy/MM/dd',
                'placeholder' => ''
            ])
            ...
            ->add('shipping_instruction_date', DateType::class, [
                'required' => false,
                'format' => 'yyyy/MM/dd',
                'placeholder' => ''
            ])
            ->add('cancel_date', DateType::class, [
                'required' => false,
                'format' => 'yyyy/MM/dd',
                'placeholder' => ''
            ])
            ...
            ->add('core_collaboration_date', DateType::class, [
                'required' => false,
                'format' => 'yyyy/MM/dd',
                'placeholder' => ''
            ])
            ...
            ->add('DeliveryType', FilterChoiceType::class, [
                'choice_label' => 'Name',
                'mapped' => false,
                'expanded' => true,
                'choices' => $this->deliveryTypeRepository->findAll(),
                'choice_value' => 'id',
                'data' => $data->getDeliveryTypeId()
            ])
            ;
        ...
        $builder->addEventListener(FormEvents::POST_SET_DATA, [$this, 'addSenderForm']);
...
//        $builder->addEventListener(FormEvents::POST_SUBMIT, [$this, 'validateOrderItems']);
     ...
     * @param FormEvent $event
     */
    public function addSenderForm(FormEvent $event)
    {
        /** @var Order $Order */
        $Order = $event->getData();
        $data = $Order ? $Order->getSender() : null;
        $form = $event->getForm();
        $form->add('Sender', SenderType::class, [
            'mapped' => false,
            'data' => $data,
        ]);
    }
