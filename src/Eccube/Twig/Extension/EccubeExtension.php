    ...
    public function getClassCategoriesAsJson(Product $Product)
    {
        ...
        foreach ($Product->getProductClasses() as $ProductClass) {
            ...
            $class_categories[$class_category_id1]['#'.$class_category_id2] = [
                ...
                'price01' => $ProductClass->getPrice() === null ? '' : number_format($ProductClass->getPrice()),
                'price02' => number_format($ProductClass->getPrice()),
                'price01_inc_tax' => $ProductClass->getPrice() === null ? '' : number_format($ProductClass->getPrice01IncTax()),
                'price02_inc_tax' => number_format($ProductClass->getPrice02IncTax()),
                'price01_with_currency' => $ProductClass->getPrice() === null ? '' : $this->getPriceFilter($ProductClass->getPrice()),
