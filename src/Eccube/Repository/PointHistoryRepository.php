...
class PointHistoryRepository extends AbstractRepository
{
    ...
    public function getQueryBuilderBySearchData($searchData)
    {
        ...
        if (isset($searchData['multi']) && StringUtil::isNotBlank($searchData['multi'])) {
            ...
            $qb
                ->andWhere('p.id = :customer_id OR CONCAT(c.name01, c.name02) LIKE :name OR CONCAT(c.kana01, c.kana02) LIKE :kana OR c.email LIKE :email  OR c.company_name LIKE :company_name OR c.postal_code LIKE :postal_code  OR c.addr01 LIKE :addr01 OR c.addr02 LIKE :addr02 OR c.phone_number LIKE :phone_number OR c.phone_number LIKE :phone_number OR c.addr03 LIKE :addr03')
                ...
                ->setParameter('addr01', '%'.$clean_key_multi.'%')
                ->setParameter('addr02', '%'.$clean_key_multi.'%')
                ->setParameter('addr03', '%'.$clean_key_multi.'%')
