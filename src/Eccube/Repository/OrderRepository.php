        ...
        if (isset($searchData['multi']) && StringUtil::isNotBlank($searchData['multi'])) {
            ...
            $qb
                ->andWhere('o.id = :multi OR CONCAT(o.name01, o.name02) LIKE :likemulti OR '.
                            ...
                            'o.order_no LIKE :likemulti OR o.email LIKE :likemulti OR oipc.code LIKE :likemulti OR o.phone_number LIKE :likemulti')
                ->setParameter('multi', $multi)
                ->setParameter('likemulti', '%'.$clean_key_multi.'%')
                ->setParameter('company_name', '%'.$searchData['multi'].'%')
                ->setParameter('customerId', $clean_key_multi)
                ->setParameter('deliveryWeekDay', $clean_key_multi);
        }
